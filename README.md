...
| **[AC](https://github.com/RuiCruz16/AC)** | Developed an end-to-end WNBA machine learning pipeline that forecasts conference team rankings, head coach turnover, and individual player awards using temporal validation, custom basketball feature engineering, and tuned ensemble models. |
| **[DS](https://github.com/RuiCruz16/DS)** | Built an AI-driven recommendation engine using the Gemini API, featuring real-time catalog synchronization with Google Cloud Pub/Sub, a cached Flask backend, an embeddable React microfrontend via Webpack Module Federation, and continuous deployment to Cloud Run. |
| **[PRI](https://github.com/RuiCruz16/PRI)** | Engineered a disease information retrieval application that combines multi-source web scraping, Solr-based lexical and vector indexing, and a modern React and FastAPI interface deployed with Docker Compose. |
| **[SDLE](https://github.com/RuiCruz16/SDLE)** | Implemented a fault-tolerant distributed shopping list system inspired by the Dynamo architecture, featuring consistent hashing, quorum consensus, hinted handoff, and eventual consistency via conflict-free replicated data types (CRDTs). |
| **[SGI](https://github.com/RuiCruz16/SGI)** | Engineered an interactive 3D WebGL graphics suite using Three.js, featuring hierarchical indoor scene modeling, real-time lighting and shadows, and an underwater ecosystem simulation powered by custom GLSL shaders, Reynolds boids flocking, and BVH spatial acceleration. |
| **[DDJD](https://github.com/RuiCruz16/DDJD)** | Programmed a 3D open-world ocean survival game in Unity 6 and C#, featuring modular grid-based raft building, ScriptableObject-driven crafting and resource gathering, dynamic weather systems, and finite-state-machine shark AI. |
| **[EDAA](https://github.com/RuiCruz16/EDAA)** | Engineered advanced algorithmic solutions including a C++ Chinese Postman Problem solver using custom Fibonacci Heaps and Blossom V matching, alongside a real-time Python/Pygame simulation demonstrating Quadtree spatial partitioning versus brute-force collision detection. |
| **[LGP](https://github.com/RuiCruz16/LGP)** | Created an interactive manufacturing Digital Twin application featuring real-time Three.js 3D model visualization, CadQuery backend geometry parsing, automated material classification through LLMs, and API-driven carbon emission analytics. |
| **[VC](https://github.com/RuiCruz16/VC)** | Implemented a multi-stage pool table vision system combining classical geometric rectification, deep-learning ball counters, state-of-the-art object detectors (YOLO11 vs. RT-DETR), and embedding-based image retrieval utilizing autoencoders and Chamfer distance. |
